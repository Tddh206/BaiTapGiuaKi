...
<p>Fullname</p>
    ...
    <select name="group" required>
        ...
        <option value="4" <?php echo $row['group'] == 4 ? 'selected' : ''; ?>>Nhóm 4</option>
        <option value="5" <?php echo $row['group'] == 5 ? 'selected' : ''; ?>>Nhóm 5</option>
        <option value="6" <?php echo $row['group'] == 6 ? 'selected' : ''; ?>>Nhóm 6</option>
        <option value="7" <?php echo $row['group'] == 7 ? 'selected' : ''; ?>>Nhóm 7</option>
        <option value="8" <?php echo $row['group'] == 8 ? 'selected' : ''; ?>>Nhóm 8</option>
        <option value="9" <?php echo $row['group'] == 9 ? 'selected' : ''; ?>>Nhóm 9</option>
